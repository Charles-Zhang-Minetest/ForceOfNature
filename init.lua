...
minetest.register_chatcommand("fn", {
    func = function(name, params)
      ...
      if params:sub(0,2) == "ds" and params:len() > 3 then
        ...
        minetest.bulk_set_node(targetLocs, {name="default:obsidian"})
        -- Generate lava base
        local baseHeight = 5
        ...
        minetest.bulk_set_node(targetLocs, {name="default:lava_source"})
      ...
      elseif params:sub(0,4) == "path" and params:len() > 5 then
        ...
        minetest.bulk_set_node(targetLocs, {name=ternary(blockname == "default", "default:obsidian", blockname)})
  ...
  - /fn path length blockname - Generate path of a given block, "default" blockname to obsidian.
